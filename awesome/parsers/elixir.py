...
class AwesomeElixirParser(AbstractAwesomeParser):
    AWESOME_TITLE = 'elixir'
    AWESOME_README_URL = 'https://raw.githubusercontent.com/h4cc/awesome-elixir/master/README.md'
