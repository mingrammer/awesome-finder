...
class AwesomeAndroidParser(AbstractAwesomeParser):
    AWESOME_TITLE = 'android'
    AWESOME_README_URL = 'https://raw.githubusercontent.com/JStumpp/awesome-android/master/readme.md'
