...
class AwesomeErlangParser(AbstractAwesomeParser):
    AWESOME_TITLE = 'erlang'
    AWESOME_README_URL = 'https://raw.githubusercontent.com/drobakowski/awesome-erlang/master/README.md'
