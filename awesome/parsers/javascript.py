...
class AwesomeJavaScriptParser(AbstractAwesomeParser):
    AWESOME_TITLE = 'javascript'
    AWESOME_README_URL = 'https://raw.githubusercontent.com/sorrycc/awesome-javascript/master/README.md'

    def find_content(self):
        readme = self.read_readme()
        content = readme.split('----')[1]
        lines = []
