...
class AwesomeGoParser(AbstractAwesomeParser):
    AWESOME_TITLE = 'go'
    AWESOME_README_URL = 'https://raw.githubusercontent.com/avelino/awesome-go/master/README.md'

    def find_content(self):
        readme = self.read_readme()
        content = readme.split('- [Tutorials](#tutorials)')[1]
        lines = []
